            ...
            items(items = items, itemContent = { item ->
                Row(modifier = Modifier
                    ...
                    Column(modifier = Modifier.weight(3f)) {
                        ...
                        Text(text = item.namalengkap, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "tanggal lahir", fontSize = 14.sp)
                        Text(text = item.tanggallahir, fontSize = 16.sp, fontWeight =
                        FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
                        Text(text = "Alamat lengkap", fontSize = 14.sp)
                        Text(text = item.Alamatlengkap, fontSize = 16.sp,
                            fontWeight = FontWeight.Bold)
                    }
                    Column(modifier = Modifier.weight(3f)) {
