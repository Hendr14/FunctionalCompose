...
fun FormPencatatanSampah(setoranSampahDao: SetoranSampahDao) {
    val Nama_lengkap = remember { mutableStateOf(TextFieldValue("")) }
    val Tanggal_lahir= remember { mutableStateOf(TextFieldValue("")) }
    val Alamat_lengkap= remember { mutableStateOf(TextFieldValue("")) }
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            value = Alamat_lengkap.value,
            onValueChange = {
                Alamat_lengkap.value = it
            },
            modifier = Modifier
                .padding(4.dp)
                .fillMaxWidth(),
        ...
        Row (modifier = Modifier
            ...
            Button(modifier = Modifier.weight(5f), onClick = {
                ...
                val item = SetoranSampah(id,Nama_lengkap.value.text, Tanggal_lahir.value.text, Alamat_lengkap.value.text, Notelephone.value.text)
                scope.launch {
                    setoranSampahDao.insertAll(item)
                }
                Nama_lengkap.value = TextFieldValue("")
                Tanggal_lahir.value = TextFieldValue("")
                Alamat_lengkap.value = TextFieldValue("")
